...
<div class="mt-5 px-5">
    ...
    <div id="dismiss-alert"
        class="hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300 bg-teal-50 border border-teal-200 rounded-md p-4 mt-3"
        role="alert">
        <div class="flex">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-900 uppercase">
                                    Category</th>
                                <th scope="col"
                                    class="px-6 py-3 text-center text-xs font-medium text-gray-900 uppercase">Action
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                <td
                                    ...
                                    <img src="{{ $post->cover }}" class="w-16"></td>
                                ...
                                <td class="px-6 py-2 whitespace-nowrap text-center text-sm font-medium">
                                    <a href="{{ route('post.show',$post->slug) }}"
                                        class="p-2 rounded-full inline-flex justify-center items-center gap-2 border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 transition-all text-sm dark:focus:ring-gray-900 dark:focus:ring-offset-gray-800">
                                    ...
                                    <form action="{{ route('post.destroy',$post->id) }}" method="post" class="inline">
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="p-2 rounded-full inline-flex justify-center items-center gap-2 border border-transparent font-semibold bg-red-500 text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 transition-all text-sm dark:focus:ring-gray-900 dark:focus:ring-offset-gray-800">
                                            <i class="fa-regular fa-trash-can"></i>
                                        </button>
                                        <a href="{{ route('post.edit',$post->id) }}"
                                            class="p-2 rounded-full inline-flex justify-center items-center gap-2 border border-transparent font-semibold bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 transition-all text-sm dark:focus:ring-gray-900 dark:focus:ring-offset-gray-800">
